  ...
  return (
    <div className={styles.landingContainer}>
      <div className={styles.titlesContainer}>
        ...
        <div className={styles.landingInner}>
          <div className={styles.landingBelow}>
            <img
              src={reducedMotion ? waterStill : waterGif}
              alt="flowing water"
            />
          </div>
          <div
            className={styles.landingAbove}
          ...
          >
            ...
            <h1>
              <Link to="/account/register" style={{ color: themeObj.color }}>
                Register to start creating custom link pages.
              </Link>
            </h1>
          </div>
        </div>
      ...
      <div className={styles.productDetailsContainer}>
        ...
        <FAQs />
        <iframe
          src="https://cdn.forms-content.sg-form.com/a3165ac8-03da-11ed-90c9-7edf428d4714"
