...
import defaultAnim from './default.json';
import divRepulse from './divRepulse.json';
import emmiterAbsorber from './emitterAbsorber.json';
...
const ANIMATION_PRESETS = {
  ...
  'divRepulse': divRepulse,
  'emmiterAbsorber': emmiterAbsorber,
  'emitters': emitters,
