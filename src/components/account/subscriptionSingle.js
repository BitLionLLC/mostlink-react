...
import styles from './subscriptionSingle.module.css';
            ...
            <table className={styles.table} style={{...tableStyle}}>
                <thead>
                    <tr style={{...trStyle}}>
                        ...
                        <td className={styles.tdCentered} style={{...tdStyle}}>{props.tierName}</td>
                    </tr>
                </thead>
                <tbody>
                    {props.attributes.map((attribute, i) => {
                        return (
                            <tr key={attribute.name} style={i < props.attributes.length - 1 ? {...trStyle} : null}>
                                ...
                                <td className={styles.tdCentered} style={{...tdStyle}}>{getDisplayOfAttribute(attribute[props.tierName.toLowerCase()])}</td>
                            </tr>
                        )
                    })}
                </tbody>
