  ...
  return (
    <div className={styles.termsAndConditionsContainer}>
      <div className={styles.termsAndConditions}>
        ...
        <ul>
          <li>
            <p><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named Mostlink</p>
          </li>
          <li>
          ...
          <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to BitLion, LLC (dba Wonder Development), 2058 Maple Ave, Apt D1-4, Hatfield PA 19440.</p>
          </li>
          <li>
          ...
          <li>
            <p><strong>Website</strong> refers to Mostlink, accessible from <a href="https://www.mostlink.co" rel="external nofollow noopener noreferrer" target="_blank">https://www.mostlink.co</a></p>
          </li>
          <li>
        ...
        <p>If You are a copyright owner, or authorized on behalf of one, and You believe that the copyrighted work has been copied in a way that constitutes copyright infringement that is taking place through the Service, You must submit Your notice in writing to the attention of our copyright agent via email at grant@thebitlion.com and include in Your notice a detailed description of the alleged infringement.</p>
        ...
        <p>You can contact our copyright agent via email at grant@thebitlion.com.
