...
const TermsAndConditions = () => {
    return (
        <div className={styles.termsAndConditionsContainer}>
            ...
            <li>
            <p><strong>Website</strong> refers to Mostlink, accessible from <a href="https://www.mostlink.co" rel="external nofollow noopener" target="_blank">https://www.mostlink.co</a></p>
            </li>
            <li>
