    ...
    <div className={styles.termsAndConditionsContainer}>
      <div className={styles.termsAndConditions}>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to BitLion, LLC, Hatfield, PA 19440.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Mostlink, accessible from{" "}
              <a
                href="https://www.mostlink.co"
                rel="external nofollow noopener noreferrer"
                target="_blank"
              >
                https://www.mostlink.co
              </a>
            </p>
          </li>
          <li>
        ...
        <p>
          ...
          our copyright agent via email at grant@thebitlion.com and include in
        ...
        <p>
          You can contact our copyright agent via email at grant@thebitlion.com.
