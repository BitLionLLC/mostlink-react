...
const MiniSite = ({ site }) => {
  const { setIsEditModalOpen, setEditModalOpenedWith } =
  ...
  return (
    <div
      className={styles.miniSiteWrapper}
      style={{
    ...
    >
      ...
      <span className={styles.title} style={{ color: titlesColor }}>
        {title}
      </span>
      <span className={styles.subtitle} style={{ color: titlesColor }}>
        {subtitle}
      </span>
